...
func (d Direction) MarshalBSUP(m *tsup.MarshalBSUPContext) (super.Type, error) {
	return m.MarshalValue(d.String())
}

func (d *Direction) UnmarshalBSUP(u *tsup.UnmarshalBSUPContext, val super.Value) error {

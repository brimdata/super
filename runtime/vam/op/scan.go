...
func NewScanner(rctx *runtime.Context, cache *vcache.Cache, parent sbuf.Puller, pool *lake.Pool, paths []field.Path, pruner expr.Evaluator, progress *sbuf.Progress) *Scanner {
	return &Scanner{
		cache:      cache,
		rctx:       rctx,

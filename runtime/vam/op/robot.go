...
func (o *Robot) openHTTP(off uint32, url string) (vio.Puller, error) {
	...
	// OpenHTTP now returns a vector puller directly, so no dematerializing.
	return o.env.OpenHTTP(o.rctx.Context, o.rctx.Sctx, url, o.format, method, headers, body, o.pushdown)
}

...
func (j *Join) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(j.sctx, args, "join"); ok {
		return vec
	}
	args = underAll(args)
	splitsVal := args[0]
...
func (l *Levenshtein) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(l.sctx, args, "levenshtein"); ok {
		return vec
	}
	args = underAll(args)
	for _, a := range args {
...
func (p *Position) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(p.sctx, args, "position"); ok {
		return vec
	}
	args = underAll(args)
...
func (r *Replace) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(r.sctx, args, "replace"); ok {
		return vec
	}
	args = underAll(args)
...
func (s *Split) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(s.sctx, args, "split"); ok {
		return vec
	}
	args = underAll(args)
	for i := range args {
...
func (t *ToLower) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(t.sctx, args, "lower"); ok {
		return vec
	}
...
func (t *ToUpper) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(t.sctx, args, "upper"); ok {
		return vec
	}
	v := vector.Under(args[0])
	if v.Type() != super.TypeString {
...
func (t *Trim) Call(args ...vector.Any) vector.Any {
	if vec, ok := expr.CheckForErrorThenNullThenNone(t.sctx, args, "trim"); ok {
		return vec
	}

...
with a SuperDB lakehouse.
The Python package supports loading data into a lakehouse as well as
querying and retrieving results in the [JSUP format](../formats/jsup.md).
The Python client interacts with the lakehouse via the REST API served by

...
For records, a bit vector of length NF is encoded as a tag-encoded value of
...
Note that when there are no optional fields, the tag-encoded bit vector
has length 0.  Following the option bits is a concatenation

...
> TODO: the parsing rules here are not currently implemented
...
Note that the `FLOAT(n)` SQL types are not yet implemented by SuperSQL.

> TODO: these aliases are not yet implemented
...
> TODO: The large numbers should parse as uint64.  Floats should require . or e
...
9223372036854775807
error({message:"cannot cast to int8",on:9.223372036854776e+18})
error({message:"cannot cast to int16",on:9.223372036854776e+18})
error({message:"cannot cast to int32",on:9.223372036854776e+18})
-9223372036854775808
```
...
error({message:"cannot cast to uint8",on:9.223372036854776e+18})
error({message:"cannot cast to uint16",on:9.223372036854776e+18})
error({message:"cannot cast to uint32",on:9.223372036854776e+18})

...
The set type conforms to the definition of the
...
_set expressions_ or other
SuperSQL functions that produce sets.

Any SUP text defining an [set value](../../formats/sup.html#243-set-value)
...
An empty set value has the form `|[]|`.

#### Set Type

A set type has the syntax defined for the
[set type](../../formats/sup.md#253-set-type)
...
An empty set type defaults to an array of type null, i.e., `|[null]|`.

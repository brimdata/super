...
```mdtest-spq {data-layout='no-labels'} {style='text-align:left;width:20%'}
# spq
const PI=3.14
values PI
# input
...
```mdtest-spq fails {data-layout='no-labels'} {style='text-align:left;width:60%'}
# spq
( 
  const PI=3.14
  values PI
...
```mdtest-spq {data-layout='no-labels'} {style='text-align:left;width:50%'}
# spq
values 1, 2 -- , 3
/*
| aggregate sum(this)

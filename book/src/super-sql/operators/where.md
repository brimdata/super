...
The `where` operator requires a boolean-valued expression and does not support
[search expressions](../search.md).  Use the
[`search`](search.md) operator if you want search syntax.

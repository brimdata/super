...
&emsp; **unnest** &mdash; traverse and join nested array values optionally as a subquery
...
> TODO: flatten should take maps and do what 'over m'  currently does when 
...
```mdtest-spq
# spq
unnest {s,f:flatten(r)} into ( values {s,key:f.key[1],f.value} )
# input
{s:"foo",r:{a:1,b:2}}
{s:"bar",r:{a:3,b:4}}
# expected output

...
TODO: expand this to cover standard expression subqueries
both correlated and non-correlated.  Also, windows (lag, sliding, etc)
...
A lateral scope has the form `into ( <query> )` and currently appears

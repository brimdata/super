...
The super-structured output can be serialized into a number of
different formats as [described above](#formats).
...
The following command-line options are avaiable to any command that
writes output:

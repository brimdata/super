...
- [SuperSQL](super-sql/intro.md)
    ...
    - [Functions](super-sql/functions/intro.md)
        - [Errors](super-sql/functions/errors/index.md)
        ...
        - [Math](super-sql/functions/math/index.md)
        ...
        - [Time](super-sql/functions/time/index.md)
            - [abs](super-sql/functions/time/abs.md)
            - [bucket](super-sql/functions/time/bucket.md)
            - [date_part](super-sql/functions/time/date_part.md)
            - [every](super-sql/functions/time/every.md)
            - [now](super-sql/functions/time/now.md)
            - [strftime](super-sql/functions/time/strftime.md)
        - [Records](super-sql/functions/records/index.md)
            - [crop](super-sql/functions/records/crop.md)
        ...
        - [Strings](super-sql/functions/strings/index.md)
        ...
        - [Types](super-sql/functions/types/index.md)
        ...
        - [Parsing](super-sql/functions/parsing/index.md)

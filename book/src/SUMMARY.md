...
- [SuperSQL](super-sql/intro.md)
    ...
    - [Data Types](super-sql/types/intro.md)
        - [Number Types](super-sql/types/numbers.md)
        - [String](super-sql/types/string.md)
        - [Bytes](super-sql/types/bytes.md)
        - [Network Types](super-sql/types/network.md)
        - [Time Types](super-sql/types/time.md)
        - [Type Type](super-sql/types/type.md)
    ...
    - [Patterns](super-sql/patterns.md)

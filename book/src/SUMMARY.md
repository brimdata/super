...
- [SuperSQL](super-sql/intro.md)
    - [Queries](super-sql/queries/intro.md)
        ...
        - [Declarations](super-sql/queries/declarations/intro.md)
            ...
            - [Functions](super-sql/queries/declarations/functions.md)
            - [Operators](super-sql/queries/declarations/operators.md)
            - [Types](super-sql/queries/declarations/types.md)
        - [Expressions](super-sql/queries/expressions/intro.md)
            - [Aggregate Functions](super-sql/queries/expressions/aggregates.md)
            - [Arithmetic](super-sql/queries/expressions/arithmetic.md)
            - [Cast](super-sql/queries/expressions/cast.md)
            - [Comparisons](super-sql/queries/expressions/comparisons.md)
            - [Conditional](super-sql/queries/expressions/conditional.md)
            - [Containment](super-sql/queries/expressions/containment.md)
            - [F-Strings](super-sql/queries/expressions/f-strings.md)
        ...
        - [Patterns](super-sql/queries/patterns.md)

...
- [CLI](command/super.md)
    - [Sub-commands](command/sub-commands.md)
        ...
        - [super dev](command/dev.md)
    - [Options](command/options.md)
    - [Input](command/input.md)
    - [Output](command/output.md)
    - [Formats](command/formats.md)
- [SuperSQL](super-sql/intro.md)
    ...
    - [Operators](super-sql/operators/intro.md)
        ...
        - [blend](super-sql/operators/blend.md)
...
- [Developer](dev/intro.md)
    ...
    - [Integrations](dev/integrations/intro.md)
        ...
        - [Zeek](dev/integrations/zeek/intro.md)
            ...
            - [JSON Logs](dev/integrations/zeek/shaping.md)
